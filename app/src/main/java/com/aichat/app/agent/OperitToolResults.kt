...
data class WorkflowDetailResultData(
    ...
    val name: String,
    val description: String,
    val nodes: List<WorkflowNodeInfo>,
    val connections: List<WorkflowConnectionInfo>,
    val enabled: Boolean,
    val createdAt: Long,
    val updatedAt: Long,
    val lastExecutionTime: Long? = null,
    ...
    data class WorkflowConnectionInfo(
    ...
    override fun toString(): String {
        ...
        nodes.forEach { node ->
            ...
            if (node.additionalInfo.isNotEmpty()) {
                node.additionalInfo.forEach { (key, value) ->
                    sb.appendLine("    $key: $value")
                }
            }
        }
