...
- 🔄 **消息撤回** - 发送者消息支持长按撤回
- 🧠 **思考内容显示** - AI 机器人完整支持显示 reasoning_content 思考内容
- 🔍 **模型搜索** - 模型选择下拉框支持搜索过滤
- 📐 **UI 优化** - API 端点和模型选择框变小，输入框扁平化设计
- ⚙️ **设置界面优化** - 移除冗余内容，布局更紧凑
- ⚡ 代码逻辑优化和 Bug 修复
